...
const STAFF = [
  { staffId: 'STF-001', name: 'ラメシュ', status: '在籍中' },
  { staffId: 'STF-002', name: 'スニタ', status: '在籍中' },
  { staffId: 'STF-003', name: 'ビカス', status: '在籍中' },
  { staffId: 'STF-004', name: 'アルジュン', status: '在籍中' },
  { staffId: 'STF-005', name: 'サンジャイ', status: '休職中' },
];
...
const CASES = [
  {
    caseId: 'CAS-2024-0011', registeredBy: 'ボハラ', occurredOn: '2024-05-20',
    typeKey: 'postage', type: '郵送費',
    advancerCategory: 'サービススタッフ', advancer: 'ラメシュ',
    targetCategory: 'サービススタッフ', target: 'ラメシュ',
    costBearerCategory: 'VC', costBearer: 'VC',
    amount: 4500, reason: '異動に伴う私物の郵送', detail: '東京都 → 北海道（宅配便2箱）',
    extras: { 送り元: '東京都', 送り先: '北海道' },
    attachments: [
      { name: 'receipt_0520.pdf', kind: '領収書', uploadedBy: 'ボハラ', uploadedAt: '2024-05-20 09:30' },
      { name: 'slip_0520.jpg', kind: '配送伝票', uploadedBy: 'ボハラ', uploadedAt: '2024-05-20 09:30' },
    ],
    settlement: {
    ...
    comments: [{ by: 'モハン', at: '2024-05-21 10:12', text: '配送伝票の宛先を確認しました。問題ありません。' }],
    history: [
      { at: '2024-05-20 09:30', by: 'ボハラ', action: '登録' },
      { at: '2024-05-21 10:12', by: 'モハン', action: '承認', field: 'ステータス', before: '未処理', after: '処理中' },
    ],
  },
  {
    caseId: 'CAS-2024-0010', registeredBy: 'ボハラ', occurredOn: '2024-05-19',
    typeKey: 'hospital', type: '病院代',
    advancerCategory: '派遣先・農家', advancer: 'グリーンファーム農園',
    targetCategory: 'サービススタッフ', target: 'スニタ',
    ...
    attachments: [{ name: 'medical_0519.pdf', kind: '診療明細', uploadedBy: 'ボハラ', uploadedAt: '2024-05-19 16:40' }],
    // §1-8 農家への処理は完了、スタッフへの処理は未処理 → 案件全体は「処理中」
    settlement: {
      method: '派遣先への請求額から控除', plannedAmount: 12000, processedAmount: 12000,
      targetMonth: '2024年5月', processedOn: '2024-05-22', handler: 'プラカシュ',
    ...
    billing: {
      host: 'グリーンファーム農園', month: '2024年5月', staff: 'スニタ', type: '病院代',
      amount: 12000, kind: '控除', reason: '農家立替分の精算', display: '立替精算（病院代）',
      status: '完了', processedOn: '2024-05-22', handler: 'プラカシュ',
    },
    history: [
      { at: '2024-05-19 16:40', by: 'ボハラ', action: '登録' },
      { at: '2024-05-22 11:05', by: 'プラカシュ', action: '精算処理', field: '立替者への精算', before: '未処理', after: '完了' },
    ],
  },
  {
    caseId: 'CAS-2024-0009', registeredBy: 'ディペシュ', occurredOn: '2024-05-18',
    typeKey: 'dormitory', type: '待機寮',
    advancerCategory: 'VC', advancer: 'VC',
    targetCategory: 'サービススタッフ', target: 'ビカス',
    costBearerCategory: 'サービススタッフ', costBearer: 'サービススタッフ',
    ...
    comments: [{ by: 'モハン', at: '2024-05-20 09:02', text: '天引き誓約書の添付をお願いします。' }],
    rejection: { reason: '添付書類（天引き誓約書）が未提出のため、再提出をお願いします。', by: 'モハン', at: '2024-05-20 09:02' },
    history: [
      { at: '2024-05-18 13:20', by: 'ディペシュ', action: '登録' },
      { at: '2024-05-20 09:02', by: 'モハン', action: '差戻し', field: 'ステータス', before: '未処理', after: '差戻し' },
    ],
  },
  {
    caseId: 'CAS-2024-0008', registeredBy: 'ディペシュ', occurredOn: '2024-05-17',
    ...
    attachments: [{ name: 'invoice_wifi_05.pdf', kind: '請求書', uploadedBy: 'ディペシュ', uploadedAt: '2024-05-17 10:05' }],
    settlement: {
      method: 'VC経費処理', plannedAmount: 6800, processedAmount: 6800,
      targetMonth: '2024年5月', processedOn: '2024-05-19', handler: 'プラカシュ', status: '完了',
    },
    recovery: {
    ...
    billing: {
      ...
      status: '処理中', handler: 'プラカシュ',
    },
    history: [
      { at: '2024-05-17 10:05', by: 'ディペシュ', action: '登録' },
      { at: '2024-05-19 15:30', by: 'プラカシュ', action: '精算処理', field: '立替者への精算', before: '未処理', after: '完了' },
    ],
  },
  {
    caseId: 'CAS-2024-0007', registeredBy: 'ボハラ', occurredOn: '2024-05-16',
    typeKey: 'flight', type: 'フライト代',
    advancerCategory: 'サービススタッフ', advancer: 'アルジュン',
    targetCategory: 'サービススタッフ', target: 'アルジュン',
    costBearerCategory: 'サービススタッフ', costBearer: 'サービススタッフ',
    amount: 68000, reason: '一時帰国のための航空券', detail: '成田 → ハノイ（往復）',
    note: '退職に伴い最終給与で回収予定',
    extras: { 出発地: '成田', 到着地: 'ハノイ', 利用日: '2024-06-10', 交通手段: '航空機' },
    attachments: [
      { name: 'ticket.pdf', kind: '領収書', uploadedBy: 'ボハラ', uploadedAt: '2024-05-16 08:45' },
      { name: 'pledge_takahashi.pdf', kind: '天引き誓約書', uploadedBy: 'ビノド', uploadedAt: '2024-05-30 14:20' },
    ],
    settlement: {
      method: '本人へ振込', plannedAmount: 68000, processedAmount: 68000,
      targetMonth: '2024年5月', processedOn: '2024-05-24', handler: 'プラカシュ', status: '完了',
    },
    recovery: {
      method: '給与天引き', plannedAmount: 68000, processedAmount: 20000,
      targetMonth: '2024年6月〜', processedOn: '2024-06-25', handler: 'プラカシュ',
    ...
    wantsInstallment: true,
    resignation: {
      consentedOn: '2024-05-30', pledgeAttached: true, confirmedBy: 'ビノド',
      recoverableFromFinalSalary: false, uncollectableAmount: 24000,
      followUp: '最終給与で回収できない残額は本人へ請求書を送付し、指定口座へ振込。',
      note: '2024年7月末 退職予定',
    },
    comments: [{ by: 'ビノド', at: '2024-05-30 14:20', text: '天引き誓約書を受領し、本人同意を確認しました。' }],
    history: [
      { at: '2024-05-16 08:45', by: 'ボハラ', action: '登録' },
  ...
  {
    caseId: 'CAS-2024-0006', registeredBy: 'ディペシュ', occurredOn: '2024-05-15',
    typeKey: 'transportation', type: '交通費',
    advancerCategory: 'サービススタッフ', advancer: 'サンジャイ',
    targetCategory: 'サービススタッフ', target: 'サンジャイ',
    costBearerCategory: 'VC', costBearer: 'VC',
    amount: 3200, reason: '面談のための移動', detail: '大阪府 → 東京都（新幹線）',
    extras: { 出発地: '大阪府', 到着地: '東京都', 利用日: '2024-05-15', 交通手段: '新幹線' },
    attachments: [{ name: 'ticket_0515.jpg', kind: '領収書', uploadedBy: 'ディペシュ', uploadedAt: '2024-05-15 11:10' }],
    settlement: {
      method: '本人へ振込', plannedAmount: 3200, processedAmount: 3200,
      targetMonth: '2024年5月', processedOn: '2024-05-18', handler: 'プラカシュ', status: '完了',
    },
    recovery: { method: '回収不要', status: '対象外', note: 'VC負担のため回収なし' },
    history: [
      { at: '2024-05-15 11:10', by: 'ディペシュ', action: '登録' },
