...
export const MOCK_CASES = [
  {
    ...
    resignation: null,
    comments: [
      { by: '佐々木 内容確認', at: '2024-05-21 10:12', text: '配送伝票の宛先を確認しました。問題ありません。' },
    ],
    history: [
      { at: '2024-05-20 09:30', by: '山本 明日香', action: '登録', field: '', before: '', after: '' },
  ...
  },
  {
    ...
    comments: [],
    history: [
      { at: '2024-05-19 16:40', by: '山本 明日香', action: '登録', field: '', before: '', after: '' },
      { at: '2024-05-22 11:05', by: '経理 井上', action: '精算処理', field: '農家処理', before: '未処理', after: '完了' },
    ],
    rejection: null,
    cancellation: null,
  },
  {
    ...
    resignation: null,
    comments: [
      { by: '佐々木 内容確認', at: '2024-05-20 09:02', text: '天引き誓約書の添付をお願いします。' },
    ],
    history: [
      { at: '2024-05-18 13:20', by: '中村 事務', action: '登録', field: '', before: '', after: '' },
  ...
  },
  {
    ...
    comments: [],
    history: [
      { at: '2024-05-17 10:05', by: '中村 事務', action: '登録', field: '', before: '', after: '' },
  ...
  },
  {
    ...
    comments: [
      { by: '労務 大西', at: '2024-05-30 14:20', text: '天引き誓約書を受領し、本人同意を確認しました。' },
    ],
    history: [
      { at: '2024-05-16 08:45', by: '山本 明日香', action: '登録', field: '', before: '', after: '' },
  ...
  },
  {
    ...
    comments: [],
    history: [
      { at: '2024-05-15 11:10', by: '中村 事務', action: '登録', field: '', before: '', after: '' },
